...
// import { signInWithEmailAndPassword , onAuthStateChanged, signOut, signInWithPopup, FacebookAuthProvider } from 'firebase/auth';
              ...
              <div className="mt-10">
                ...
                <div className="mt-6 grid grid-cols-2 gap-4">
                  <button
                    ...
                    className="flex w-full items-center justify-center gap-3 rounded-md bg-[#0026ff] px-3 py-1.5 text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1D9BF0]"
                  >
                    <svg
                      className="h-5 w-5"
                      aria-hidden="true"
